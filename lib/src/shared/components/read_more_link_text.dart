...
class ReadMoreLinkText extends StatefulWidget {
  ...
  @override
  _ReadMoreLinkTextState createState() => _ReadMoreLinkTextState();
}
...
class _ReadMoreLinkTextState extends State<ReadMoreLinkText> {
  bool _readMore = true;
